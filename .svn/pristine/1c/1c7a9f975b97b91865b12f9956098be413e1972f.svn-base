...
//    assetImageGenerator.maximumSize = CGSizeMake(SCREEN_WIDTH, SCREEN_WIDTH/320.0*250);
    ...
    CGSize size = CGSizeMake(SCREEN_WIDTH, SCREEN_WIDTH/320.0*250);
    return [thumbnailImage imageByScalingAndCroppingForSize: size];
}
