...
@interface IGFieldpaceViewController (){
    UITextField *_name;
    UITextField *_style;
...
@implementation IGFieldpaceViewController
...
//    bgImgView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    UILabel *title = [UITools createLabelWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, 115/2, 190, 14) fontNumber:14 text:@"场地方名称"];
    title.textColor = UIColorFromInt(137, 137, 137, 1);
    [self.view addSubview:title];
    
    UITextField *hostText = [UITools createTextFiledWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, KGetViewBottomestYPosition(title)+7, 190, 25) fontNumber:12 placeText:@"输入"];
//    hostText.keyboardType = UIKeyboardTypePhonePad;
    ...
    UILabel *title1 = [UITools createLabelWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, KGetViewBottomestYPosition(hostText)+10, 190, 14) fontNumber:14 text:@"风格"];
    title1.textColor = UIColorFromInt(137, 137, 137, 1);
    [self.view addSubview:title1];
    
    UITextField *styleText = [UITools createTextFiledWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, KGetViewBottomestYPosition(title1)+7, 190, 25) fontNumber:12 placeText:@"输入"];
//    styleText.keyboardType = UIKeyboardTypePhonePad;
    styleText.textColor = UIColorFromInt(67, 67, 67, 1);
    styleText.backgroundColor = UIColorFromInt(27, 27, 27, 1);
    styleText.clearsOnBeginEditing = YES;
    [self.view addSubview:styleText];
    _style = styleText;
    
    UILabel *title2 = [UITools createLabelWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, KGetViewBottomestYPosition(styleText)+10, 190, 14) fontNumber:14 text:@"地址"];
    title2.textColor = UIColorFromInt(137, 137, 137, 1);
    [self.view addSubview:title2];
    
    UITextField *addressText = [UITools createTextFiledWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, KGetViewBottomestYPosition(title2)+7, 190, 25) fontNumber:12 placeText:@"输入"];
//    addressText.keyboardType = UIKeyboardTypePhonePad;
    addressText.textColor = UIColorFromInt(67, 67, 67, 1);
    addressText.backgroundColor = UIColorFromInt(27, 27, 27, 1);
...
- (void)btnClick{
    [[IGUserManager sharedInstance] reginfoWithphone:self.phone username:_name.text type:@"1" style:_style.text address:_address.text isHub:YES success:^(AFHTTPRequestOperation *operation, id responseObject) {
