...
- (id)initWithFrame:(CGRect)frame
{
    ...
    NSLog(@"magiframe%@",NSStringFromCGRect(frame));
    return self;
}
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    CGFloat h =currentImageView.image.size.height;
