...
@interface IGHostViewController ()
{
    UITextField *_name;
}
...
@implementation IGHostViewController
...
//    bgImgView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    UILabel *title = [UITools createLabelWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, 110, 100, 14) fontNumber:14 text:@"主办方名称"];
...
- (void)btnClick{
    [[IGUserManager sharedInstance] reginfoWithphone:self.phone username:_name.text type:@"2" style:nil address:nil isHub:YES success:^(AFHTTPRequestOperation *operation, id responseObject) {
