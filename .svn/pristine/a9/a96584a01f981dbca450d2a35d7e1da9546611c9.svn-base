...
@interface IGBandViewController ()
{
    UITextField *_name;
    UITextField *_style;
}
...
@implementation IGBandViewController
...
//    bgImgView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    UILabel *title = [UITools createLabelWithFrame:CGRectMake((SCREEN_WIDTH - 190)/2, 220/2, 190, 14) fontNumber:14 text:@"乐队名称"];
...
- (void)btnClick{
    [[IGUserManager sharedInstance] reginfoWithphone:self.phone username:_name.text type:@"3" style:_style.text address:nil isHub:YES success:^(AFHTTPRequestOperation *operation, id responseObject) {
