...
- (void)setUpButton
{
    ...
    [button setImage:[UIImage imageNamed:@"选择1.png"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"选择.png"] forState:UIControlStateSelected];
...
- (void)loadImageNearIndex:(NSUInteger)index
{
    if (index > 0) {
        ...
        [SDWebImageManager downloadWithURL:[NSURL URLWithString:photo.url]];
    }
