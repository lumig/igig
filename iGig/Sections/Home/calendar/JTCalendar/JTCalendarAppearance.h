...
@property (strong, nonatomic) UIColor *colorLableColor;
@property (strong, nonatomic) UIFont *colorLabyeFont;


// 自定义红色,蓝色
@property (strong, nonatomic) UIColor *colorRed;
@property (strong, nonatomic) UIColor *colorBlue;
